...
ItemDatablock.set(Identifier.create("Item", 174), {
    type: "consumable",
    name: "Glow Sticks",
    model: () => new NativeItemModel(174)
});
...
ItemDatablock.set(Identifier.create("Item", 221), {
    type: "consumable",
    name: "Hope",
    model: () => new NativeItemModel(114)
});
...
ItemDatablock.set(Identifier.create("Item", 220), {
    type: "consumable",
    name: "Cfoam Grenade",
    model: () => new NativeItemModel(115)
});
...
ItemDatablock.set(Identifier.create("Item", 181), {
    type: "rifle",
    name: "Data Sphere",
    serial: "DATA_SPHERE",
    model: () => new NativeItemModel(181)
});
...
ItemDatablock.set(Identifier.create("Item", 93), {
    ...
    name: "Key Gold",
    serial: "KEY_GOLD",
    model: () => new NativeItemModel(93)
});
ItemDatablock.set(Identifier.create("Item", 94), {
    type: "rifle",
    name: "Key Brown",
    serial: "KEY_BROWN",
    model: () => new NativeItemModel(94)
});
...
ItemDatablock.set(Identifier.create("Item", 217), {
    type: "rifle",
    name: "Corrupted Decoder",
    serial: "PD",
    model: () => new NativeItemModel(129)
});
