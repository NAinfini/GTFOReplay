...
for (const version of ["0.0.1", "0.0.2"]) ModuleLoader.registerHeader("Vanilla.Map.Doors", version, {
    parse: async (data, header, snapshot) => {
        ...
        for (let i = 0; i < nDoors; ++i) {
            ...
            doors.set(id, {
                ...
                modelName: version === "0.0.2" ? await BitHelper.readString(data) : undefined,
            });
