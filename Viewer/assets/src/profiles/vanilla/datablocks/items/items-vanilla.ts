...
import { NativeItemModel } from "../../renderer/models/prebuilt/nativeItem.js";
...
// Booster artifacts deliberately share the Muted Low appearance.
ItemDatablock.set(Identifier.create("Item", 152), {
    type: "rifle",
    name: "Artifact",
    model: () => new NativeItemModel(152)
});
