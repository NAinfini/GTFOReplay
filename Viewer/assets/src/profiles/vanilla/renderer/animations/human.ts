...
import { fingerParents, HumanFingerJoints } from "./player-fingers.js";
export { fingerParents, HumanFingerJoints };
...
export const PlayerJoints = [...HumanJoints, ...HumanFingerJoints] as const;
export type HumanJoints = typeof HumanJoints[number];
export type PlayerJoints = typeof PlayerJoints[number];
export type PlayerAnimation = AnimFunc<PlayerJoints>;
export type PlayerMask = AvatarMask<PlayerJoints>;
...
export type HumanSkeleton<ExtraJoints extends string = never> = AvatarSkeleton<HumanJoints | ExtraJoints>;
...
export const humanEmptyAnim: HumanAnim = empty<HumanJoints>(HumanJoints);
